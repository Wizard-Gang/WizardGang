...
function services(build) {
  ...
  const sourceMap = [
    ["Site configuration", "The matching business details, colors, content, or layout change"],
    ["Page template", "That customer-facing page changes"],
    ["Images and assets", "The new files ship with the next deployment"],
    ["Route configuration", "Pages and menu links update together"],
    ["Git commit", "GitHub keeps a dated record of the change"],
    ["Push to the deployment branch", "Cloudflare checks, builds, and deploys the site"],
