...
const PERMANENT_REDIRECT_ROUTES = [
  ...
  { kind: "external", source: "/github/", destination: GITHUB_ORG },
  { kind: "internal", source: "/resume", destination: "/work/" },
  { kind: "internal", source: "/resume/", destination: "/work/" },
  { kind: "internal", source: "/professional", destination: "/work/" },
  { kind: "internal", source: "/professional/", destination: "/work/" },
  { kind: "external", source: "/compliance", destination: `${DEMO_ORIGIN}/compliance` },
  { kind: "external", source: "/compliance/", destination: `${DEMO_ORIGIN}/compliance` },
  { kind: "external", source: "/accessibility", destination: `${DEMO_ORIGIN}/accessibility` },
  { kind: "external", source: "/accessibility/", destination: `${DEMO_ORIGIN}/accessibility` },
  { kind: "external", source: "/security", destination: `${DEMO_ORIGIN}/compliance` },
  { kind: "external", source: "/security/", destination: `${DEMO_ORIGIN}/compliance` },
  { kind: "internal", source: "/services/example", destination: "/services/" },
  { kind: "internal", source: "/services/example/", destination: "/services/" },
