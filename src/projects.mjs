export const projects = [
  {
    ...
    description: "A live multiplayer game run as a governed production system: ISO/IEC 27001- and 42001-aligned controls, public evidence, accessible interfaces, and a hard spend limit.",
  ...
  },
  {
    ...
    description: "A fighting game built on a deterministic, rollback-ready simulation, with accessible controls and training tools that read the same frame data the engine runs on.",
