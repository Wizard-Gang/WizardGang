...
export const SPANISH_TRANSLATIONS = new Map<string, string>([
    ...
    ["Career detail", "Detalle profesional"],
    ["Professional work remains separately attributed.", "El trabajo profesional permanece atribuido por separado."],
    ["Detailed roles, projects, systems, integrations, deployments, and skills remain on the professional Work surface so this Team profile stays concise and attribution remains clear.", "Los roles, proyectos, sistemas, integraciones, despliegues y habilidades detallados permanecen en la superficie profesional de Trayectoria para que este perfil de Equipo sea conciso y la atribución permanezca clara."],
